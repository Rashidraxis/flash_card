...
try:
    ...
    original_data = pandas.read_csv("data/japanese-word.csv")
...
unknown_button.config(highlightthickness=0, borderwidth=0)
unknown_button.grid(column=0, row=1)

check_img = PhotoImage(file="images/right.png")
known_button = Button(image=check_img, command=is_known)
known_button.config(highlightthickness=0, borderwidth=0)
